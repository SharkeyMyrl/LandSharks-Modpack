...
Blueprint.addRecipe("Sleeves", <tfctech:metal/brass_sleeve>, [<tfctech:metal/brass_long_rod>]);
Blueprint.addRecipe("Sleeves", <tfctech:metal/tin_sleeve>, [<tfctech:metal/tin_long_rod>]);
Blueprint.addRecipe("Sleeves", <tfctech:metal/steel_sleeve>, [<tfctech:metal/steel_long_rod>]);
